...
public class MundoLiterarioDificil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectofinal/UInterfaces/resources/back.png"))); // NOI18N
    ...
    private void panelNivel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel2MouseClicked
        ...
        if(puntos==10){
            ...
            iniciarTemporizador();
        }else if(puntos>=10 && intentosNivel2!=0){
            nivelSeleccionado=2;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel3MouseClicked
        ...
        if(puntos==20){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=20 && intentosNivel3!=0){
            nivelSeleccionado=3;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel4MouseClicked
        if(puntos==30){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=30 && intentosNivel4!=0){
            nivelSeleccionado=4;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel6MouseClicked
        if(puntos==50){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=50 && intentosNivel6!=0){
            nivelSeleccionado=6;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel7MouseClicked
        ...
        if(puntos==60){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=60 && intentosNivel7!=0){
            nivelSeleccionado=7;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel8MouseClicked
        ...
        if(puntos==70){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=70 && intentosNivel8!=0){
            nivelSeleccionado=8;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel9MouseClicked
        ...
        if(puntos==80){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=80 && intentosNivel9!=0){
            nivelSeleccionado=9;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel10MouseClicked
        ...
        if(puntos==90){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=90 && intentosNivel10!=0){
            nivelSeleccionado=10;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel5MouseClicked
        ...
        if(puntos==40){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=40 && intentosNivel5!=0){
            nivelSeleccionado=5;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
