...
public class MundoLiterario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectofinal/UInterfaces/resources/back.png"))); // NOI18N
        ...
        headerLayout.setVerticalGroup(
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(backButton4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void panelNivel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel9MouseClicked
        ...
        if(puntos==40){
            ...
            iniciarTemporizador();
        }else if(puntos>=40 && intentosNivel9!=0){
            nivelSeleccionado=9;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel6MouseClicked
        if(puntos==25){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=25 && intentosNivel6!=0){
            nivelSeleccionado=6;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel8MouseClicked
        ...
        if(puntos==35){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=35 && intentosNivel8!=0){
            nivelSeleccionado=8;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel7MouseClicked
        ...
        if(puntos==30){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=30 && intentosNivel7!=0){
            nivelSeleccionado=7;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel10MouseClicked
        ...
        if(puntos==45){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=45 && intentosNivel10!=0){
            nivelSeleccionado=10;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel4MouseClicked
        if(puntos==15){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=15 && intentosNivel4!=0){
            nivelSeleccionado=4;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void panelNivel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel3MouseClicked
        ...
        if(puntos==10){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=10 && intentosNivel3!=0){
            nivelSeleccionado=3;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else{
    ...
    private void panelNivel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel2MouseClicked
        ...
        if(puntos==5){
            ...
            iniciarTemporizador();
        }else if(puntos>=5 && intentosNivel2!=0){
            nivelSeleccionado=2;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else{
    ...
    private void panelNivel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNivel5MouseClicked
        ...
        if(puntos==20){
            ...
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        }else if(puntos>=20 && intentosNivel5!=0){
            nivelSeleccionado=5;
            panelNivelMouseClicked(generarNumeroAleatorio()); // para el nivel 1
            iniciarTemporizador();
        } else{
    ...
    private void backButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backButton4MouseClicked
        NivelDificultad nivelDificultad = new NivelDificultad(userIDF,idJuegoF);
        ...
        if (respuestaSeleccionada.equalsIgnoreCase(respuestaCorrecta)) {
            ...
            if(nivelSeleccionado==2){
                ...
                if(intentosNivel2==0){
                    ...
                    jLabel15.setText(String.valueOf(puntos));
                    intentosNivel2++;
                    System.out.println(intentosNivel2);
                }else{
                    jLabelResultado.setText("Ya pasaste este nivel no puedes ganar mas puntuación");
                    repaint();
                }
