...
public class Dificultad extends javax.swing.JFrame {
     ...
     */
    public Dificultad(int userID, int juego) {
        userIDF=userID;
        juegoID=juego;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        */
        WordQuestFrame wq = new WordQuestFrame(userIDF,juegoID);
        wq.setVisible(true);
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        WordQuestFrameDificil wqd = new WordQuestFrameDificil(userIDF,juegoID);
        wqd.setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Ventana1 vt = new Ventana1(userIDF,juegoID);
        vt.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dificultad(userIDF,juegoID).setVisible(true);
            }
        });
    }
    ...
    class FondoPanel extends JPanel{
        ...
        public void paint(Graphics g){
            imagen = new ImageIcon(getClass().getResource("/proyectofinal/UInterfaces/AntoniJuego1/ImagenMenu/Dificultad.png")).getImage();
